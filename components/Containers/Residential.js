    ...
    return (
        <>
            <section className={`${styles.services} dark:text-white`}>
                ...
                <div className='flex flex-wrap justify-center dark:text-white sm:justify-between'>
                    ...
                    <figure className={styles.containerStand}>
                        <img className={`${styles.imgRectangle2} transition ease-in-out delay-150`} src={`${enabled ? '/images/figures/Rectangle21.svg' : '/images/figures/Rectangle2.svg'}`} />
                ...
                <div className='flex flex-wrap justify-center dark:text-white sm:justify-between'>
                    ...
                    <figure className={styles.containerStandTwo}>
                        <img className='w-full h-56 transition ease-in-out delay-150' src={`${enabled ? '/images/figures/Path211.svg' : '/images/figures/Path21.svg' }`} />
